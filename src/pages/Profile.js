...
<div className="col-12">
            ...
            <div className="mt-2"><button  className={['btn','btn-primary' ,'btn-primary' ,'profile-button',classes.profilebutton].join(' ')} type="button">Update Profile picture</button></div>
            </div>
